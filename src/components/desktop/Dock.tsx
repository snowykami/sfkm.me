      ...
      <div className="flex items-center space-x-3">
        {apps.map((app, index) => {
          ...
          return (
            <div
              key={app.id}
              className={`w-14 h-14 rounded-xl flex flex-col items-center justify-center cursor-pointer transition-all duration-200 hover:scale-110 active:scale-95 relative ${
                isMobile
