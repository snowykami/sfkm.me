...
export const getNewWindowColorScheme = (
  colorScheme: Partial<WindowState["colorScheme"]> = {},
): WindowState["colorScheme"] => {
  return {
    bg: "bg-transparent",
...
export default function Music({ windowId = WINDOW_ID }: AppProps) {
  ...
  useEffect(() => {
    ...
    updateWindow(windowId, {
      ...
      colorScheme: getNewWindowColorScheme({
        backgroundImage:
          currentSong.cover || "https://cdn.liteyuki.org/blog/background.png",
      }),
    });
