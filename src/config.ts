import type { Contact, Friend, Project, Site, Skill, SkillBadge } from '@/types'

import type { BackgroundContext } from '@/types/background'
...
interface Config {
  ...
  languageResources: Record<
    string,
    Record<string, Record<string, string | Record<string, unknown>>>
  >
}
...
const config: Config = {
  meta: {
    ...
    authors: ['Snowykami'],
    description:
      'Welcome to Snowykami OS, powered by Next.js and Tailwind CSS.',
  ...
  profile: {
    ...
    skillBadges: [
      // 浅色和深色都适配
      {
        ...
        label: 'Python',
        className:
          'bg-teal-100 dark:bg-teal-500/20 text-teal-700 dark:text-teal-300 hover:bg-teal-200 dark:hover:bg-teal-500/30 border-teal-200 dark:border-teal-500/30',
      },
      {
        key: 'go',
        label: 'Go',
        className:
          'bg-sky-100 dark:bg-sky-400/20 text-sky-700 dark:text-sky-300 hover:bg-sky-200 dark:hover:bg-sky-400/30 border-sky-200 dark:border-sky-400/30',
      },
      {
        key: 'docker',
        label: 'Docker',
        className:
          'bg-blue-100 dark:bg-blue-400/20 text-blue-700 dark:text-blue-200 hover:bg-blue-200 dark:hover:bg-blue-400/30 border-blue-200 dark:border-blue-400/30',
      },
      {
        key: 'k8s',
        label: 'Kubernetes',
        className:
          'bg-indigo-100 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-200 dark:hover:bg-indigo-500/30 border-indigo-200 dark:border-indigo-500/30',
      },
      {
        key: 'cloud',
        label: 'Cloud Native',
        className:
          'bg-cyan-100 dark:bg-cyan-400/20 text-cyan-700 dark:text-cyan-300 hover:bg-cyan-200 dark:hover:bg-cyan-400/30 border-cyan-200 dark:border-cyan-400/30',
      },
      {
        key: 'typescript',
        label: 'TypeScript',
        className:
          'bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-500/30 border-blue-200 dark:border-blue-500/30',
      },
      {
        key: 'vue',
        label: 'Vue.js',
        className:
          'bg-emerald-100 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-200 dark:hover:bg-emerald-500/30 border-emerald-200 dark:border-emerald-500/30',
      },
      {
        key: 'linux',
        label: 'Linux',
        className:
          'bg-gray-100 dark:bg-gray-500/20 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-500/30 border-gray-200 dark:border-gray-500/30',
      },
      {
        key: 'devops',
        label: 'DevOps',
        className:
          'bg-purple-100 dark:bg-purple-500/20 text-purple-700 dark:text-purple-300 hover:bg-purple-200 dark:hover:bg-purple-500/30 border-purple-200 dark:border-purple-500/30',
      },
    ],
  },
  contacts: [
    {
      ...
      value: 'a@sfkm.me',
      link: 'mailto:a@sfkm.me',
    },
    {
      icon: Github,
      label: 'GitHub',
      value: 'github.com/snowykami',
    ...
    },
    {
      ...
      label: 'contacts.ncm',
      value: 'snowykami',
      link: 'https://music.163.com/#/user/home?id=1491388449',
    },
    {
      icon: Twitter,
      label: 'X',
    ...
    zh: {
      translation: {
        ...
        about: {
          ...
          description2:
            '基础部分是由vercel v0生成，后续大部分由作者本人进行维护和更新(不太会react qwq)。',
          description3:
            '如果你喜欢这个项目，欢迎在<a href=\'https://github.com/snowykami/sfkm.me\'>GitHub</a>上给个Star！',
        },
        browser: {
          title: '浏览器',
        },
        ...
        projects: {
          ...
          magipoke: {
            name: 'Magipoke APP',
            description:
              '掌上重邮，一个涵盖学校生活的多功能应用，APP在各个平台使用原生技术开发，后端使用云原生微服务架构',
            link: 'https://app.redrock.team/#/',
          },
          serverstatus: {
            name: '服务器状态',
        ...
        terminal: {
          ...
          commands: {
            ...
            chlang: {
              ...
              usage:
                '使用 <code>chlang [language]</code> 切换语言，支持 \'zh\', \'en\', \'ja\' 等',
            ...
            curl: {
              description:
                '模拟 curl 请求，支持常用参数（-X, -H, -d, --data, --header, --json, -i 等）',
              noUrl: '请提供 URL',
              failed: '请求失败: {{error}}',
            },
            pwd: {
            ...
            win: {
              ...
              unknown:
                '未知子命令: {{subCommand}}. 可用子命令: ls, close, hide, max, min, reset, open',
              opened: '已打开窗口 {{title}}',
              title: '标题',
              size: '大小',
              status: '状态',
    ...
    en: {
      translation: {
        ...
        about: {
          ...
          description1:
            'This is a macOS-style personal card page that supports multiple windows, Dock, menu bar, theme switching, and more.',
          description2:
            'The basic part is generated by vercel v0, and most of the subsequent maintenance and updates are done by the author himself (not very good at React qwq).',
          description3:
            'If you like this project, feel free to give it a star on <a href=\'https://github.com/snowykami/sfkm.me\'>GitHub</a>!',
        },
        browser: {
          title: 'Browser',
        },
        ...
        marquee: {
          ...
          sentence2:
            'For a better experience, it\'s recommended to use fullscreen mode on desktop',
          sentence3: 'Click the avatar in the top left for more fun!',
          sentence4: 'The source code of this site is open on GitHub',
          sentence5:
            'How about listening to some music? Just click the play button, lyrics included!',
        },
        menu: {
          about: 'About',
        ...
        profile: {
          ...
          description3:
            'Mountains high, moon small, water falls, stones emerge.',
        ...
        projects: {
          ...
          litedoc: {
            name: 'Litedoc',
            description:
              'A convenient markdown documentation generator for Python modules',
          },
          liteyukibot: {
            name: 'Liteyuki Bot',
            description:
              'A lightweight cross-platform Python chat bot framework',
        ...
        terminal: {
          title: 'Terminal',
          prompt:
            'Welcome to the Void Terminal! Enter <code>help</code> to see available commands.',
          ...
          commands: {
            about: {
              ...
              content:
                'This is a simulated terminal that can perform some web operations',
            },
            cat: {
            ...
            chlang: {
              ...
              usage:
                'Use <code>chlang [language]</code> to switch language, supports \'zh\', \'en\', \'ja\', etc.',
            ...
            help: {
              ...
              usage:
                'Use <code>help [command]</code> to view help for a specific command',
            },
            kill: {
            ...
            node: {
              description:
                'Enter Node.js interactive mode or execute a single line of code',
              exit: 'Exit Node.js interactive mode',
              enter:
                'Enter Node.js interactive mode, type <code>exit</code> to exit',
            },
            path: {
            ...
            musiclrc: {
              description:
                'Continuously display the currently playing lyrics in the terminal',
              unsupported: 'The terminal does not support dynamic output',
            },
            curl: {
              description:
                'Simulate a curl request, supports common options (-X, -H, -d, --data, --header, --json, -i, etc.)',
            ...
            win: {
              ...
              resetAndRefresh:
                'All window states have been reset and the page refreshed',
              unknown:
                'Unknown subcommand: {{subCommand}}. Available subcommands: ls, close, hide, max, min, reset, open',
    ...
    ja: {
      translation: {
        ...
        about: {
          title: 'この名刺について',
          description1:
            'これはmacOSスタイルの個人名刺ページで、複数のウィンドウ、Dock、メニューバー、テーマ切り替えなどの機能をサポートしています。',
          description2:
            '基本部分はvercel v0によって生成され、その後の大部分は作者本人がメンテナンスと更新を行っています（Reactはあまり得意ではありません qwq）。',
          description3:
            'このプロジェクトが気に入ったら、<a href=\'https://github.com/snowykami/sfkm.me\'>GitHub</a>でスターをつけてください！',
        },
        contacts: {
          title: '連絡先',
        ...
        marquee: {
          ...
          sentence2:
            'デスクトップではフルスクリーンモードを使用することをお勧めします',
          sentence3:
            '左上のアバターをクリックすると、もっと楽しいことがありますよ！',
          sentence4: 'このサイトのソースコードはGitHubで公開されています',
          sentence5:
            '音楽を聴いてみませんか？ただ再生ボタンをクリックするだけで、歌詞も表示されます！',
        },
        menu: {
          about: '概要',
          language: '言語切り替え',
        ...
        projects: {
          ...
          litedoc: {
            name: 'Litedoc',
            description:
              '便利なPythonモジュールのMarkdownドキュメント生成ツール',
          },
          liteyukibot: {
            name: 'Liteユキ　ボット',
            description:
              '軽量なクロスプラットフォームのPythonチャットボットフレームワーク',
        ...
        terminal: {
          title: 'ターミナル',
          prompt:
            '虚空ターミナルへようこそ！<code>help</code> を入力して利用可能なコマンドを確認してください。',
          ...
          commands: {
            about: {
              ...
              content:
                'これはウェブ操作を行うことができるシミュレートされたターミナルです',
            },
            cat: {
            ...
            chlang: {
              ...
              usage:
                '<code>chlang [language]</code> を使用して言語を切り替えます。\'zh\', \'en\', \'ja\' などをサポート',
            ...
            echo: {
              ...
              usage:
                '<code>echo [text]</code> を使用して指定されたテキストを出力',
            },
            exit: {
            ...
            help: {
              ...
              usage:
                '<code>help [command]</code> を使用して特定のコマンドのヘルプを表示',
            },
            kill: {
            ...
            ls: {
              description:
                '現在のディレクトリ内のファイルとディレクトリをリスト表示',
            },
            node: {
              description:
                'Node.js インタラクティブモードに入るか、単一行のコードを実行',
              exit: 'Node.js インタラクティブモードを終了',
              enter:
                'Node.js インタラクティブモードに入る。<code>exit</code> を入力して終了',
            },
            path: {
            ...
            curl: {
              description:
                'curl リクエストをシミュレート。一般的なオプション (-X, -H, -d, --data, --header, --json, -i など) をサポート',
              noUrl: 'URL を指定してください',
            ...
            win: {
              ...
              resetAndRefresh:
                'すべてのウィンドウ状態をリセットし、ページをリフレッシュしました',
              unknown:
                '不明なサブコマンド：{{subCommand}}. 利用可能なサブコマンド：ls, close, hide, max, min, reset, open',
